        ...
        <div class="container">
            ...
            <div class="row special-list">
                ...
                foreach ($items as $item) {
                    ...
                    echo "<button style='width:50%; padding: 0px; color: #FFFFFF; background-color: #000000; border: 1px solid #000000;' onMouseOver='this.style.backgroundColor=\"#b0b435\"' onMouseOut='this.style.backgroundColor=\"#000000\"' type='submit' class='btn btn-primary'>";
                        echo "Add to cart";
                    echo "</button>";
