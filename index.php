        ...
        <div class="container">
            ...
            <div class="row special-list">
                ...
                foreach ($items as $item) {
                    ...
                    echo "<img src='data:image/jpeg;charset=utf8;base64," .base64_encode($item['item_image']). "' class='img-fluid' alt='data:image/jpeg;charset=utf8;base64," .base64_encode(file_get_contents('images/300.webp')). "' />";
