    ...
    <div class="container-fluid gedf-wrapper">
        <div class="row">
            ...
            <div class="col-md-6 gedf-main">
                ...
                <!--- \\\\\\\Post-->
				<!--- Note this section will only exist IF user is a donor -->
                ...
                <div class="card gedf-card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="ml-2">
                                    <div class="h5 m-0">@username_here</div>
                                    <div class="h7 text-muted">John Does Pizza</div>
                                </div>
                            </div>
                            <div>
                                <div class="dropdown">
                    ...
                    <div class="card-footer">
                        <a href="#" class="card-link"><i class="fa fa-gittip"></i> Add to Cart</a>
