        ...
        <div class="row">
            ...
            <div class="col-md-6 gedf-main">
                ...
                <div class="card gedf-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-muted h7">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<i class="fa fa-clock-o"></i>Expiration: <?php echo $item['item_expiration']; ?></li>
							<br>
							Item ID: <?php echo $item['item_id']; ?>
						&emsp;
						
						<button type="submit" name="deleteFromDb" value="<?php echo $item['item_id']?>"> <i class="fa fa-trash"></i>
				...
				<div class="card gedf-card">
					...
					<button type="submit" name="deleteFromDb" value="<?php echo $item['item_id']?>"> <i class="fa fa-trash"></i></button>
					&emsp;
					<input class="form-check-input" type="checkbox" id="inlineFormCheck" name="pickup_confirmed" value="<?php echo $item['item_id']?>"> Confirm Pickup
