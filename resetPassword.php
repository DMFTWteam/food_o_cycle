...
<!-- Basic -->
    ...
    <!-- End All Title Box -->
		<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form class="mt-3 review-form-box" name="formLogin" style="margin-bottom: 30%;" action='login.php' method='post'>
                        <div class="form-row" >
                            <div class="form-group col-md-6">
                                <label for="InputPassword" class="mb-0">New Password</label>
                                <input type="password" class="form-control" name="InputPassword" placeholder="Enter Password"> </div>
                            <div class="form-group col-md-6">
